...
# at the end
sam_model_checkpoint = "facebook/sam-vit-base"
device = "cuda" if torch.cuda.is_available() else "cpu"

model = SamModel.from_pretrained(sam_model_checkpoint).to(device)
# Load the SamProcessor using the facebook/sam-vit-base
# checkpoint
processor = SamProcessor.from_pretrained(sam_model_checkpoint)
